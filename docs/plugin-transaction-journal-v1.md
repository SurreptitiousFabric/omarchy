...
- `REQUEST_BOUND`: the immutable request and capability hash are durable; no candidate publication is claimed. It may advance to `PUBLICATION_INTENT`, `RECOVERY_REQUIRED`, or `MANUAL_ATTENTION`.
