...
def o8_observation:
  exact_keys(["source","rawSha256","referenceProjection","referenceState","referencePolicy","configurationEpoch"])
  and (.source | exact_keys(["kind","identity"])
...
def validate_v2($operation_id):
  exact_keys(["candidate","capabilityHash","corruptEvidenceSha256","gate","normalizedRequest","operationBindingSha256","operationId","pluginId","preExposureEvidence","publication","registry","retainedPrior","rollback","rollbackEvidence","namespaceIntent","rescan","release","terminalReceipt","schema","state","reason"])
  ...
  and (.preExposureEvidence == null or (.preExposureEvidence | o8_observation))
  and (.state | o8_state)
